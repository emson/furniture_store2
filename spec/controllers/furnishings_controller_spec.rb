...
describe FurnishingsController do
  ...
  # Furnishing. As you add validations to Furnishing, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { { "name" => "MyString" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # FurnishingsController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET index" do
    it "assigns all furnishings as @furnishings" do
      furnishing = Furnishing.create! valid_attributes
      get :index, {}, valid_session
      assigns(:furnishings).should eq([furnishing])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested furnishing as @furnishing" do
      furnishing = Furnishing.create! valid_attributes
      get :show, {:id => furnishing.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested furnishing as @furnishing" do
      furnishing = Furnishing.create! valid_attributes
      get :edit, {:id => furnishing.to_param}, valid_session
      assigns(:furnishing).should eq(furnishing)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Furnishing" do
        expect {
          post :create, {:furnishing => valid_attributes}, valid_session
      ...
      it "redirects to the created furnishing" do
        post :create, {:furnishing => valid_attributes}, valid_session
        response.should redirect_to(Furnishing.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved furnishing as @furnishing" do
        ...
        post :create, {:furnishing => { "name" => "invalid value" }}, valid_session
        assigns(:furnishing).should be_a_new(Furnishing)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested furnishing" do
        ...
        Furnishing.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => furnishing.to_param, :furnishing => { "name" => "MyString" }}, valid_session
      end

      it "assigns the requested furnishing as @furnishing" do
        furnishing = Furnishing.create! valid_attributes
        put :update, {:id => furnishing.to_param, :furnishing => valid_attributes}, valid_session
        assigns(:furnishing).should eq(furnishing)
      end
      ...
      it "redirects to the furnishing" do
        furnishing = Furnishing.create! valid_attributes
        put :update, {:id => furnishing.to_param, :furnishing => valid_attributes}, valid_session
        response.should redirect_to(furnishing)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the furnishing as @furnishing" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Furnishing.any_instance.stub(:save).and_return(false)
        put :update, {:id => furnishing.to_param, :furnishing => { "name" => "invalid value" }}, valid_session
        assigns(:furnishing).should eq(furnishing)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested furnishing" do
      furnishing = Furnishing.create! valid_attributes
      expect {
        delete :destroy, {:id => furnishing.to_param}, valid_session
      }.to change(Furnishing, :count).by(-1)
    end
    ...
    it "redirects to the furnishings list" do
      furnishing = Furnishing.create! valid_attributes
      delete :destroy, {:id => furnishing.to_param}, valid_session
      response.should redirect_to(furnishings_url)
    end
  end
